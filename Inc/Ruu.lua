...
amrko = Token:match("(%d+)")
redis:set(amrko..":VERSION",1)
redis:set(amrko..":SUDO_ID:",SUDO_USER)
redis:set(amrko..":DataCenter:",'German')
redis:set(amrko..":UserNameBot:",BOT_User)
redis:set(amrko..":NameBot:",BOT_NAME)
redis:hset(amrko..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3amrko_INSTALL","Yes")
info = {}
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..amrko..')\027[0;32m\n'
...
if msg.type == "pv" and redis:get(amrko..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end

if redis:get(amrko..'sender:'..msg.sender_user_id_..':flood') then
...
if redis:get(amrko..'group:add'..msg.chat_id_) then 
msg.GroupActive = true
else
msg.GroupActive = false
end
if msg.sender_user_id_ == 332717942 then 
...
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(amrko..':KARA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء الاساسي'
msg.TheRank = 'المنشىء الاساسي '
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(amrko..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء '
msg.TheRank = 'المنشىء '
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(amrko..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير ' 
msg.TheRank = 'مدير البوت ' 
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(amrko..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن '
msg.TheRank = 'ادمن في البوت '
msg.Rank = 6
elseif msg.GroupActive and redis:sismember(amrko..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(amrko..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(amrko..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(amrko..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(amrko..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(amrko..':WELCOME_BOT'),[[•~مـرحبآ آنآ بوت آسـمـي ]]..redis:get(amrko..':NameBot:')..[[•~آختصـآصـي حمـآيه‌‏ آلمـجمـوعآت
...
if msg.GroupActive and redis:get(amrko..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
return false 
end
...
if msg.Admin then redis:srem(amrko..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(amrko..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(amrko..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
for k, amrko in pairs(ScriptFile.amrko) do
local SearchText = msg.text:match(amrko)
if SearchText then
if not CheckFlood(msg) then
return false 
end

local GetMsg = ScriptFile.iamrko(msg,{msg.text:match(amrko)})
if GetMsg then
...
Mohammad = msg.text
if Mohammad then
if redis:sismember(amrko..'CmDlist:'..msg.chat_id_,Mohammad) then
mmdi = redis:hget(amrko..'CmD:'..msg.chat_id_,Mohammad)
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/basselabaza/amrko/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/basselabaza/amrko/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/basselabaza/amrko/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/basselabaza/amrko/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/basselabaza/amrko/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/basselabaza/amrko/master/plugins/games.lua','./plugins/games.lua')
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	mmd = redis:get(amrko..":SUDO_ID:")
redis:hset(amrko..'username:'..tonumber(mmd),'username',msg.text)
	...
	redis:set(amrko..":SUDO_ID:",msg.text)
...
download(stk,32)
	...
	if redis:get(amrko..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(amrko..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(amrko..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(amrko..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(amrko..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(amrko..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(amrko..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
if redis:get(amrko..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	if redis:get(amrko..'group:add'..msg.chat_id_) then
	redis:set(amrko..'group:name'..msg.chat_id_,msg.content_.title_)
	end
	end 
